...
class Network(minitorch.Module):
    ...
    def forward(self, x):
        ...
        temp = self.linear1.forward(minitorch.avgpool2d(self.out, (4, 4)).view(BATCH, 392)).relu()
        temp = minitorch.dropout(temp, 0.25)

        return minitorch.logsoftmax(self.linear2.forward(temp), 1)
